            ...
            case KEY_VALUE_ESC:
            {
                ...
                else
                {
                    if(s_pstActivedMenu->stLayout.iWidth > 0)
                    {
                        ...
                        SGUI_Basic_SetMask4(pstDeviceIF, &(s_pstActivedMenu->stLayout));
                        SGUI_Basic_DrawRectangle3(pstDeviceIF, &(s_pstActivedMenu->stLayout), SGUI_COLOR_BKGCLR, SGUI_COLOR_BKGCLR);
