...
void SGUI_PolarCoord_DrawArc(SGUI_SCR_DEV* pstDeviceIF, SGUI_INT iCx, SGUI_INT iCy, SGUI_INT iRadius, SGUI_INT iStartAngle, SGUI_INT iEndAngle, SGUI_COLOR eColor)
{
    ...
    SGUI_RECT				stCoveredArea1 = {0x00};
    SGUI_RECT				stCoveredArea2 = {0x00};
    SGUI_INT				iStartX, iStartY;
    SGUI_INT				iEndX, iEndY;
    ...
    if(iRadius < 1)
    {
        SGUI_Basic_DrawPoint(pstDeviceIF, iCx, iCy, eColor);
    }
    else
    {
    	/* Get arc start point and end point coordinate. */
    	SGUI_PolarCoord_GetPoint(iCx, iCy, iStartAngle, iRadius, &iStartX, &iStartY);
    	SGUI_PolarCoord_GetPoint(iCx, iCy, iEndAngle, iRadius, &iEndX, &iEndY);
        ...
        while(iPosXOffset >= iPosYOffset)
        {
            ...
            {
                // Draw edge.
                SGUI_Basic_DrawPoint(pstDeviceIF, iCx+iPosXOffset, iCy+iPosYOffset, eColor);
                SGUI_Basic_DrawPoint(pstDeviceIF, iCx-iPosXOffset, iCy+iPosYOffset, eColor);
                SGUI_Basic_DrawPoint(pstDeviceIF, iCx-iPosXOffset, iCy-iPosYOffset, eColor);
                SGUI_Basic_DrawPoint(pstDeviceIF, iCx+iPosXOffset, iCy-iPosYOffset, eColor);
                SGUI_Basic_DrawPoint(pstDeviceIF, iCx+iPosYOffset, iCy+iPosXOffset, eColor);
                SGUI_Basic_DrawPoint(pstDeviceIF, iCx-iPosYOffset, iCy+iPosXOffset, eColor);
                SGUI_Basic_DrawPoint(pstDeviceIF, iCx-iPosYOffset, iCy-iPosXOffset, eColor);
                SGUI_Basic_DrawPoint(pstDeviceIF, iCx+iPosYOffset, iCy-iPosXOffset, eColor);
